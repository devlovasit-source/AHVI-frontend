...
class _ProfileView extends StatelessWidget {
  ...
  Future<void> _fetchAndUpdateLocation(
    ...
    ).getLocationContext(forceRefresh: true);
    final permission = location['permission']?.toString() ?? 'unavailable';
...
class _FaceAnalysisPreview extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final statusPurple = isDark
        ? const Color(0xFFA78BFA)
        : const Color(0xFF8B5CF6);
    final statusPink = isDark
        ? const Color(0xFFF472B6)
        : const Color(0xFFEC4899);
    final recommendationBg = isDark
        ? const Color(0xFF3A2E12)
        : const Color(0xFFFFF8E8);
    final recommendationBorder = isDark
        ? const Color(0xFF5C4720)
        : const Color(0xFFFFE5B4);
    final recommendationTitle = isDark
