...
class AhviStyleThisProcessingCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      // Prevents the "missing Material ancestor" yellow-underline debug
      // style: this card is shown over the dimmed item-detail barrier
      // (Overlay/Stack), which has no Material/Scaffold ancestor of its own.
